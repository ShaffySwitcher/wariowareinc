...
enum BeatscriptCommand {
    BS_CMD_0, // BS_CMD_STOP
    BS_CMD_1, // BS_CMD_SCENE_RUN
    BS_CMD_2, // BS_CMD_RUN_1ARG
    BS_CMD_3, // BS_CMD_SET32
    BS_CMD_4, // BS_CMD_SET16
    BS_CMD_5, // BS_CMD_SET8
    BS_CMD_6, // BS_CMD_REST
    BS_CMD_7, 
    BS_CMD_8, 
    BS_CMD_9, // BS_CMD_SET_MUSIC
    BS_CMD_A, // BS_CMD_PLAY_SFX
    BS_CMD_B,
    BS_CMD_C,
    BS_CMD_D,
    BS_CMD_E,
    BS_CMD_F,
    BS_CMD_10, // BS_CMD_CALL
    BS_CMD_11, // BS_CMD_RETURN
    BS_CMD_12,
    BS_CMD_13,
    BS_CMD_14, // BS_CMD_GOTO
    BS_CMD_15, // BS_CMD_LOOP_MARK
    BS_CMD_16, // BS_CMD_LOOP_JUMP
    BS_CMD_17, // BS_CMD_IF_NEQ32
    BS_CMD_18, // BS_CMD_IF_NEQ16
    BS_CMD_19, // BS_CMD_IF_NEQ8
    BS_CMD_1A, // BS_CMD_IF_EQ32
    BS_CMD_1B, // BS_CMD_IF_EQ16
    BS_CMD_1C, // BS_CMD_IF_EQ8
    BS_CMD_1D, // BS_CMD_ELSE
    BS_CMD_1E, // BS_CMD_ENDIF
    BS_CMD_1F,
    BS_CMD_20,
    BS_CMD_21,
    BS_CMD_22,
    ...
    BS_CMD_25,
    BS_CMD_26,
    BS_CMD_27, // BS_CMD_SWITCH32
    BS_CMD_28, // BS_CMD_SWITCH16
    BS_CMD_29, // BS_CMD_SWITCH8
    BS_CMD_2A, // BS_CMD_DEFAULT
    BS_CMD_2B, // BS_CMD_CASE
    BS_CMD_2C, // BS_CMD_GOTO_DEFAULT
    BS_CMD_2D,
    BS_CMD_2E, // BS_CMD_PLAY_MUSIC
    BS_CMD_2F,
    BS_CMD_30, // BS_CMD_SET_SPEED
    BS_CMD_31,
    BS_CMD_32,
    BS_CMD_33, // BS_CMD_INTERP_LCD_BLEND
    BS_CMD_34, // BS_CMD_CHANGE_PALETTE
    BS_CMD_35,
    ...
    BS_CMD_45, // BS_CMD_LOOP_START
    BS_CMD_46, // BS_CMD_LOOP_END
    BS_CMD_47, // BS_CMD_LOOP_NEXT
    BS_CMD_48, // BS_CMD_ENDSWITCH
    BS_CMD_49, 
